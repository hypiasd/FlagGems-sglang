...
and adds a contiguous-input fast path that removes runtime stride
multiplication while keeping the v5 strided path intact. The Enflame suffix
gets a separate regular head-tile
...
cases, the Ascend v5 schedule, and ZIP integrity. Triton compilation and
target chip performance require online evaluation.
